...
public enum TipoDeVariable {
    ...
    STRING(10),BOOLEAN(10),CHAR(-1*Math.pow(2, 16),Math.pow(2, 16),1),BYTE(-1*Math.pow(2, 8),Math.pow(2, 8),2),INT(-1*Math.pow(2, 31),Math.pow(2, 31),3),LONG(4),FLOAT(5),DOUBLE(6),VOID;
